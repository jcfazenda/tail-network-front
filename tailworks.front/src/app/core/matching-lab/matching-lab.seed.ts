...
const JOB_SEEDS: MatchLabJobSeed[] = [
  ...
  job('job-05', 'VG-0005', 'Full Stack Developer', 'Itaú', 'Belo Horizonte - MG', 'Hibrido', 'Senior', 'Profissional para evoluir APIs e interfaces, sustentar arquitetura distribuída e acelerar entregas críticas com produto e plataforma.', 12500, 16800, { dotnet: 88, react: 82, typescript: 66, azure: 42, data: 30 }),
