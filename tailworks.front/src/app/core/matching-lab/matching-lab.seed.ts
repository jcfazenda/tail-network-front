...
const JOB_SEEDS: MatchLabJobSeed[] = [
  job('job-01', 'VG-0001', 'Backend .NET Senior', 'Itaú Unibanco', 'Rio de Janeiro - RJ', 'Hibrido', 'Senior', 'APIs de crédito de alta criticidade.', 14000, 18500, { dotnet: 94, azure: 78, docker: 72, kubernetes: 54, data: 32 }),
  job('job-02', 'VG-0002', 'Backend Java Pleno', 'Mercado Livre', 'São Paulo - SP', 'Hibrido', 'Pleno', 'Microsserviços de pagamentos e antifraude.', 10000, 13800, { java: 92, aws: 76, docker: 64, kubernetes: 48, data: 30 }),
  job('job-03', 'VG-0003', 'Frontend Angular Senior', 'CI&T', 'Rio de Janeiro - RJ', 'Remoto', 'Senior', 'Design system e jornadas B2B.', 11000, 15200, { angular: 95, typescript: 88, ux: 46, react: 28, figma: 26 }),
  job('job-04', 'VG-0004', 'Frontend React Pleno', 'Nubank', 'Curitiba - PR', 'Remoto', 'Pleno', 'Checkout de alto volume.', 9500, 13200, { react: 95, typescript: 84, ux: 38, node: 30, figma: 28 }),
  job('job-05', 'VG-0005', 'Fullstack .NET + React', 'Accenture', 'Belo Horizonte - MG', 'Hibrido', 'Senior', 'Portal clínico com APIs e front operacional.', 12500, 16800, { dotnet: 88, react: 82, typescript: 66, azure: 42, data: 30 }),
  job('job-06', 'VG-0006', 'Fullstack Java + Angular', 'Stefanini', 'Brasília - DF', 'Presencial', 'Senior', 'Produtos internos com trilha regulatória.', 11800, 16000, { java: 90, angular: 82, typescript: 58, aws: 34, qa: 26 }),
  job('job-07', 'VG-0007', 'Mobile Flutter Pleno', 'PicPay', 'Recife - PE', 'Remoto', 'Pleno', 'App financeiro focado em onboarding.', 9000, 12600, { flutter: 94, typescript: 34, aws: 28, ux: 26, qa: 25 }),
  job('job-08', 'VG-0008', 'Mobile React Native Senior', 'iFood', 'São Paulo - SP', 'Hibrido', 'Senior', 'Aplicativo logístico com geolocalização.', 11500, 15000, { 'react-native': 94, react: 72, typescript: 68, node: 34, aws: 26 }),
  job('job-09', 'VG-0009', 'DevOps Cloud Senior', 'TIVIT', 'Campinas - SP', 'Remoto', 'Senior', 'Esteira, observabilidade e containers.', 13500, 18200, { aws: 90, docker: 86, kubernetes: 80, security: 36, python: 28 }),
  job('job-10', 'VG-0010', 'Data Engineer Senior', 'Globo', 'São Paulo - SP', 'Hibrido', 'Senior', 'Pipelines analíticos e lakehouse.', 13800, 18800, { python: 90, data: 88, aws: 52, gcp: 46, ml: 26 }),
  job('job-11', 'VG-0011', 'Machine Learning Engineer', 'VTEX', 'Florianópolis - SC', 'Remoto', 'Especialista', 'Modelos preditivos e inferência.', 16000, 22000, { python: 92, ml: 90, data: 66, gcp: 46, aws: 28 }),
  job('job-12', 'VG-0012', 'QA Automação Pleno', 'Capgemini', 'Fortaleza - CE', 'Hibrido', 'Pleno', 'Automação e regressão crítica.', 8200, 11200, { qa: 94, typescript: 54, node: 36, react: 26, data: 25 }),
  job('job-13', 'VG-0013', 'Cloud Security Analyst', 'Stone', 'São Paulo - SP', 'Remoto', 'Senior', 'IAM, hardening e resposta.', 12800, 17100, { security: 92, aws: 74, azure: 56, kubernetes: 34, docker: 28 }),
  job('job-14', 'VG-0014', 'UX/UI Product Designer', 'OLX Brasil', 'Rio de Janeiro - RJ', 'Remoto', 'Pleno', 'Fluxos SaaS e prototipação.', 8500, 11800, { ux: 92, figma: 86, react: 28, angular: 26, qa: 25 }),
  job('job-15', 'VG-0015', 'Backend Node Pleno', 'Magalu', 'Porto Alegre - RS', 'Hibrido', 'Pleno', 'APIs para eventos e antifraude.', 9300, 12800, { node: 92, typescript: 68, aws: 44, data: 36, qa: 26 }),
  job('job-16', 'VG-0016', 'Platform Engineer', 'BRQ Digital Solutions', 'São Paulo - SP', 'Remoto', 'Especialista', 'Plataforma interna para times de produto.', 16500, 22800, { kubernetes: 92, docker: 84, aws: 70, security: 42, python: 36 }),
  job('job-17', 'VG-0017', 'Analytics Engineer', 'XP Inc.', 'Rio de Janeiro - RJ', 'Hibrido', 'Senior', 'Camada semântica e qualidade analítica.', 12200, 16400, { data: 92, python: 74, aws: 36, qa: 30, ml: 28 }),
  job('job-18', 'VG-0018', 'Frontend Angular Junior', 'B3', 'Salvador - BA', 'Presencial', 'Junior', 'Evolução de portais institucionais.', 4200, 6200, { angular: 88, typescript: 68, ux: 28, figma: 26, qa: 25 }),
  job('job-19', 'VG-0019', 'Java Specialist Payments', 'C6 Bank', 'São Paulo - SP', 'Hibrido', 'Especialista', 'Arquitetura de liquidação financeira.', 17000, 23500, { java: 96, aws: 62, kubernetes: 58, security: 32, data: 28 }),
  job('job-20', 'VG-0020', 'AI Product Engineer', 'Claro', 'Rio de Janeiro - RJ', 'Remoto', 'Senior', 'Aplicações assistidas por IA generativa.', 14500, 19800, { ml: 88, python: 82, react: 42, data: 36, aws: 30 }),
];
